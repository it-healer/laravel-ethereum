...
namespace ItHealer\LaravelEthereum\Services\Alchemy;
 ...
 *
 * Override individual methods via config('ethereum.compute_units').
...
class ComputeUnits
{
    ...
    {
        $overrides = (array)config('ethereum.compute_units', []);
