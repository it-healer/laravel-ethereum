...
return new class extends Migration
{
    ...
    {
        Schema::table('ethereum_alchemy_webhooks', function (Blueprint $table) {
            if (! Schema::hasColumn('ethereum_alchemy_webhooks', 'auth_token')) {
                $table->text('auth_token')->nullable()->after('signing_key');
            }
            if (! Schema::hasColumn('ethereum_alchemy_webhooks', 'account_ref')) {
